      ...
      <div className="max-w-7xl mx-auto">
        <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-r from-[#041738] via-[#2E5A88] to-[#041738] px-8 py-20 text-center shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 gap-4 sm:flex sm:flex-row sm:items-center sm:justify-center">
              <button className="w-full sm:w-auto bg-[#e9f2f5] text-brand-dark px-8 py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-2 hover:bg-slate-100 transition-all">
                Start Free Trial <MoveRight size={20} />
              </button>
              <button className="w-full sm:w-auto bg-brand-accent text-white border border-white/20 px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/20 transition-all">
                Log In
              </button>
            </div>
          </div>
