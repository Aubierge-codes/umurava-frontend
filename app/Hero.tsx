...
export default function Hero() {
  return (
    <section className="flex flex-col items-center justify-center text-center px-4 py-20 bg-[#e9f2f5] min-h-[calc(100vh-80px)]">
      ...
      <div className="mt-10 grid w-full max-w-xl grid-cols-1 gap-4 sm:flex sm:flex-row sm:justify-center">
        <button className="w-full sm:w-auto bg-brand-accent text-white px-8 py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-2 hover:bg-opacity-90 transition-all shadow-lg shadow-blue-100">
          Get Started Free <MoveRight size={20} />
        </button>
        <button className="w-full sm:w-auto bg-white border border-gray-200 text-brand-dark px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-50 transition-all">
          Log In to Dashboard
        </button>
      </div>
